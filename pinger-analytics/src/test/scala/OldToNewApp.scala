...
//  val db = factory.open(new File("/home/william/Projects/26/ladder.sauer/19-21/"), options)
//  try {
////    val testStore = MVStore.open("yaah")
////    val goma = testStore.openMap[Array[Byte], Array[Byte]]("cool")
////    goma.put()
////    import collection.JavaConverters._
////    val writer = SauerReaderWriter.writeToFile(new File("/home/william/Projects/26/ladder.sauer/db-19-21.db"))
////    var c: Long = 0
////
...
////    val writer = SauerReaderWriter.writeToFile(new File("/home/william/Projects/26/ladder.sauer/db-19-21.b.db"))
...
////    }
////
////    val writer = SauerReaderWriter.writeToFile(new File("/home/william/Projects/26/ladder.sauer/db-19-21.c.db"))
////    records.map(SauerBytes.fromBytes).foreach(writer.write)
//
//
//    val options2 = new Options()
//    val db2 = factory.open(new File("/home/william/Projects/26/ladder.sauer/19-21-Sorted/"), options2)
//    try {
//      val iterator = db2.iterator()
//      iterator.seekToFirst()
//      import collection.JavaConverters._
//      val records = iterator.asScala.map(_.getKey).map(SauerBytesBinary.fromBytes)
//      val writer = SauerReaderWriter.writeToFile(new File("/home/william/Projects/26/ladder.sauer/db-19-21.d.db"))
