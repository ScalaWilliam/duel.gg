...
////  val db = factory.open(new File("/home/william/Projects/26/ladder.sauer/data/19-21/"), options)
////
////
////  val options2 = new Options()
////  options2.createIfMissing(true)
////  val db2 = factory.open(new File("/home/william/Projects/26/ladder.sauer/data/19-21-Out-Sorted/"), options2)
////
