...
case class GameData(firstTime: ParsedTypedMessage[ConvertedServerInfoReply], nextGame: Option[ParsedTypedMessage[ConvertedServerInfoReply]], gameMessages: List[ParsedMessage])
