...
//
//object SauerReaderWriterOld {
//
//  case class ByteWriterOld(write: Array[Byte] => Unit, flush: () => Unit, close: () => Unit)
//
//  val HEADER = Array[Byte](5, 4, 3, 2, 2, 2, 3, 4, 5)
//
//  def writeToFile(file: File) = {
//    val fos = new FileOutputStream(file)
//    val byteWriter = ByteWriterOld(
//      write = fos.write,
//      flush = () => fos.flush(),
//      close = () => fos.close()
//    )
//    new SauerWriterOld(byteWriter, true)
//  }
//
...
//}
//
//class SauerWriterOld(byteWriter: ByteWriterOld, writeHeader: Boolean = true) {
//
//  if (writeHeader) {
//    byteWriter.write(SauerReaderWriterOld.HEADER)
//  }
//
