...
//  IterationMetaData ~> FilePublisher
//  IterationMetaData ~> MetaDataPublisher
//  ReceivedBytes ~> BytePublisher
//  CompletedDuel ~> Topic("completedDuels")
//  GlobalDuel ~> Topic[GlobalDuel]("globalDuels")
//  Topic("globalDuels") ~>
